...
from .service_spec_with_code import ServiceSpecWithCode
...
class ServiceFullMetadataReader:
    ...
    def __call__(self, metadata_file: Optional[str] = None,
                 ...
                 *, encoding: str = "utf-8") -> ServiceSpecWithCode:
        """
        ...
        uc_code_metadata = extract_use_case_code_metadata(use_cases_folder_path)
        ...
        new_use_case_code_info: Dict[str, UseCaseCodeInfo] = {}
        ...
        return ServiceSpecWithCode(service_info_metadata, new_use_case_code_info)


# Callable instance for loading service specs
read_full_service_metadata = ServiceFullMetadataReader()
